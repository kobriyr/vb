...
module.exports = "<p><b>Publication Ethics</b></p>\n<p>Ethical standards for publishing exist to provide high-quality research.</p>\n<p>«Volynskyi Blahovisnyk» (VB) desired to fulfill a high standard of editorial ethics and therefore the editorial board of the journal is guided by the basic standards of publishing ethics the <a href=\"https://publicationethics.org/\"><ins>Committee of Publication Ethics (COPE)</ins></a>, the Code of Conduct and best practice recommendations for journal editors, and the Code of Conduct for Journal Publishers.</p>\n<p>Submitting an article for publication, the author hereby expresses the agreement to publish the full text of the article on the Internet and agrees with the recommendations of the Committee of Publication Ethics.</p>\n<p>The authors consent to the collection and processing of personal data for the purpose of their transfer to the database in accordance with the Law of Ukraine No. 2297-VI \"On the Protection of Personal Data\" of 01.06.2010.</p>\n<br/>\n<p><b>Principles of Editor and Publisher Ethics</b></p>\n<p>The scientific edition editorial board reserves the right to reject articles that do not meet the journal’s requirements and subjects.</p>\n<p>The editorial board can reject the manuscript without reading it if it considers that the work does not correspond to the journal’s profile.</p>\n<p>The editorial board does not consider such phenomena as: <i>plagiarism; re-publication; conflict of interest; copyright disputes; breakdown result: research; research fraud</i>.</p>\n<p>The authors bear the responsibility for the reliability of their articles’ information, statistical data, accuracy of names, surnames, and citations.</p>\n<p>The editor and members of the editorial team should not disclose information about a manuscript under consideration to anyone other than those from whom professional advice is sought.</p>\n<br/>\n<p><b>Reviewing</b></p>\n<p>Reviewing of manuscripts is an important stage in the process of their publication. Each scholar is obliged to perform a certain reviewing work process.</p>\n<p>All the materials submitted for publication pass a double-blind review process.</p>\n<p>The editorial board reserves the right to reject the article or return it for revision. The author is obliged to revise the article in accordance with the comments of reviewers or the editorial board. If the author disagrees with the reader's opinion, he has the right to give a reasoned answer to the journal's editors. Under such circumstances, his/her article is reviewed at a meeting of the journal's editorial board. The editorial board can send the article to another expert for revision or revision.</p>\n<p>Simultaneous submission of manuscripts to more than one journal is not allowed.</p>\n<p>The manuscript sent for a review is considered a confidential document.</p>\n<p>After receiving positive reviews, the manuscript must undergo literary and technical editing.</p>\n<p>The final decision regarding the possibility and expediency of publication is made by the meeting of the editorial board as a whole.</p>\n<br/>\n<p><b>The Rules for Authors</b></p>\n<p>The principal duty of the author consists in giving an exact report on the conducted research and in stirring an objective discussion of its essentiality. Authors should present their results accurately and unequivocally so that their conclusions can be confirmed by other scientists without faking data acquisition or any inadequate manipulation of them.</p>\n<p>The authors of the articles bear full responsibility for the content of their articles, as well as for the fact of their publication.</p>\n<p>The article should be structured, contain enough references, and be formatted according to the requirements.</p>\n<p>Only persons who have made a significant scientific contribution to the presented work and share responsibility for the obtained results are considered co-authors of the article. The author who submits the manuscript for publication is responsible for including in the list of co-authors only persons who meet the requirements of authorship and is responsible for the consent of the co-authors of the article for its publication in the journal.</p>\n<p>Any conflicts of interest of the persons are resolved in accordance with the legislation of Ukraine in the field of intellectual property.</p>\n"
