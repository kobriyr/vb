...
var ArticleService = /** @class */ (function () {
    ...
    // @ts-ignore
    ArticleService.prototype.create = function (tom, author, author_en, number, title, title_en, pages, key_words, key_words_en, summary, summary_en, doi, biography, references, document) {
        var fd = new FormData();
        if (author) {
    ...
    // @ts-ignore
    ArticleService.prototype.update = function (id, author, author_en, number, title, title_en, pages, key_words, key_words_en, summary, summary_en, doi, biography, references, document) {
        var fd = new FormData();
        if (author) {
            fd.append('author', author);
        }
