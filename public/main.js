...
module.exports = "<p><b>«Волинський благовісник» (VB)</b> – це рецензований щорічний богословсько-історичний науковий журнал Волинської Православної Богословської Академії Української Православної Церкви Київського Патріархату. </p>\n<p>Журнал виходить  з 2013 року.</p>\n<p>«Волинський благовісник» приймає для публікації оригінальні статті та рецензії на книги, які раніше не були опубліковані та відображають дослідницький інтерес богословів та науковців.</p>\n<p>Подані на розгляд редакційної колегії матеріали проходять процедуру подвійного «сліпого» рецензування.</p>\n<p>VB покликаний стати платформою для обміну наукових напрацювань між наукою та богослов’ям, забезпечуючи взаємну інтеграцію та інкорпорацію.</p>\n<p>Наукові статті відображають кращі актуальні теоретичні роздуми, емпіричні дослідження та методологічні форми, що виражають багатство богословської традиції та презентують розвиток сучасного богослов’я.</p>\n<p>Матеріали «Волинського благовісника» висвітлюють динаміку наукових досліджень у сфері богослів’я, літургіки, аполегетики, біблеїстики й археології, церковної історії та права, антропології, сакрального мистецтва, питань релігійної етики та проблем суспільно-соціальної площини.</p>\n"
...
module.exports = "<p><b>«Volynskyy Blahovisnyk» (VB)</b> is a peer-reviewed annual theological and historical academic periodical of the Volyn Orthodox Theological Academy of the Ukrainian Orthodox Church of Kyiv Patriarchate.</p>\n<p>The journal has been published since 2013.</p>\n<p><i>VB</i> accepts for publication original articles and reviews on the books that have not previously been published and reflect the interest of theologians and scholars.</p>\n<p>Manuscripts submitted to the editorial board are subjected to a double-blind review process.</p>\n<p><i>VB</i> is intended to become a platform for the exchange of scientific achievements between science and theology, providing mutual integration and incorporation.</p>\n<p>Scientific articles involve the best current theoretical reflections, empirical researches and methodological forms that express the riches of theological tradition and present the development of current theology.</p>\n<p>Materials of <i>VB</i> cover the dynamics of scientific research in the fields of theology, liturgy, apolegetics, biblical and archeology, church history and law, anthropology, sacral art, issues of religious ethics and social problems.</p>\n"
